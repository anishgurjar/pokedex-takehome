...
RANGER_DATA = [
    {
        "name": "Ranger Oak",
        "email": "oak@pokemon-institute.org",
    ...
    {
        "name": "Ranger Erika",
        "email": "erika@pokemon-institute.org",
        "specialization": "Grass",
    },
    {
        "name": "Ranger Surge",
        "email": "surge@pokemon-institute.org",
    ...
    {
        "name": "Ranger Blaine",
        "email": "blaine@pokemon-institute.org",
        "specialization": "Fire",
    },
    {
        "name": "Ranger Koga",
        "email": "koga@pokemon-institute.org",
    ...
    {
        "name": "Ranger Jasmine",
        "email": "jasmine@pokemon-institute.org",
        "specialization": "Steel",
    },
    {
        "name": "Ranger Chuck",
        "email": "chuck@pokemon-institute.org",
        "specialization": "Fighting",
    },
    {
        "name": "Ranger Pryce",
        "email": "pryce@pokemon-institute.org",
        "specialization": "Ice",
    },
    {
        "name": "Ranger Clair",
        "email": "clair@pokemon-institute.org",
        "specialization": "Dragon",
    },
    {
        "name": "Ranger Bugsy",
        "email": "bugsy@pokemon-institute.org",
        "specialization": "Bug",
    },
    {
        "name": "Ranger Morty",
        "email": "morty@pokemon-institute.org",
    ...
    {
        "name": "Ranger Roxanne",
        "email": "roxanne@pokemon-institute.org",
        "specialization": "Rock",
    },
    {
        "name": "Ranger Brawly",
    ...
    {
        "name": "Ranger Norman",
        "email": "norman@pokemon-institute.org",
        "specialization": "Normal",
    },
    {
        "name": "Ranger Winona",
        "email": "winona@pokemon-institute.org",
        "specialization": "Flying",
    },
    {
        "name": "Ranger Tate",
        "email": "tate@pokemon-institute.org",
        "specialization": "Psychic",
    },
    {
        "name": "Ranger Wallace",
        "email": "wallace@pokemon-institute.org",
        "specialization": "Water",
    },
    {
        "name": "Ranger Roark",
        "email": "roark@pokemon-institute.org",
        "specialization": "Rock",
    },
    {
    ...
    {
        "name": "Ranger Wake",
        "email": "wake@pokemon-institute.org",
        "specialization": "Water",
    },
    {
        "name": "Ranger Fantina",
        "email": "fantina@pokemon-institute.org",
        "specialization": "Ghost",
    },
    {
        "name": "Ranger Byron",
        "email": "byron@pokemon-institute.org",
        "specialization": "Steel",
    },
    {
        "name": "Ranger Candice",
        "email": "candice@pokemon-institute.org",
        "specialization": "Ice",
    },
    {
        "name": "Ranger Volkner",
...
def get_pokemon_for_region(all_pokemon, region_name):
    """Return species for a region: mostly regional, some crossover."""
